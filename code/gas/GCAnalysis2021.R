...
# Read in data 
# Read in data 
df.2021 = read_csv('data/gas/GC_Summer21.csv')  %>% 
...
#write.table(df.2021, 'data/gas/df.2021.csv', sep="\t")
df.clean.2021 = read_csv('data/gas/df.2021.csv')
air_samples <- df.clean.2021 %>% filter(grepl("Air",depth)) %>% 
...
#write.csv(dat.clean.2021, 'data/gas/dat_clean_summer21.csv')

dat = read_csv('data/gas/dat_clean_summer21.csv')
